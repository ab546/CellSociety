...
import java.util.*;
public class WatorGridBackup extends Grid{
	int sharkmove;
	int fishmove;
	int fishpercent;
	int sharkpercent;
	...
	WatorCell[][] nextgrid;
	public WatorGridBackup(int size,int inputfishmove, int inputsharkmove, int sharkstarvationturns, int percentfish, int percentshark){
		super(size);
	...
	public void migrate(int i,int j,WatorCell animal){
		...
		//System.out.println(timeAliveCount);
